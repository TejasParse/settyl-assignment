                        ...
                        <select name="id" id="id" onChange={onChangeId} >
                            {
                                markers.map((elmt)=>{
                                    return(
                                        <option value={`${elmt.id}`}>{elmt.id}</option>
                                    )
                                })
                            }
                        </select>
                        <div>
                            Latitude <input type="number" name="lat" id="lat" value={latRef} onInput={(event)=> changeLat(event.target.value)} />
                        </div>
                        <div>
                            Longitude <input type="number" name="lng" id="lng" value={lngRef} onInput={(event)=> changeLng(event.target.value)}/>
                        </div>
